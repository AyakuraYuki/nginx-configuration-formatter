...
package cc.ayakurayuki.psi.parser;

import static cc.ayakurayuki.psi.Types.BINARY_OPERATOR;
import static cc.ayakurayuki.psi.Types.BLOCK_STMT;
import static cc.ayakurayuki.psi.Types.CARET_TILDE;
import static cc.ayakurayuki.psi.Types.COMMENT;
import static cc.ayakurayuki.psi.Types.CONCATENATED_EXPR;
import static cc.ayakurayuki.psi.Types.CONDITION_EXPR;
import static cc.ayakurayuki.psi.Types.CONDITION_STMT;
import static cc.ayakurayuki.psi.Types.DIRECTIVE_STMT;
import static cc.ayakurayuki.psi.Types.DQSTRING;
import static cc.ayakurayuki.psi.Types.DQUOTE;
import static cc.ayakurayuki.psi.Types.GEO;
import static cc.ayakurayuki.psi.Types.GEO_BLOCK_CONTENT;
import static cc.ayakurayuki.psi.Types.GEO_BLOCK_STMT;
import static cc.ayakurayuki.psi.Types.GEO_DEFAULT;
import static cc.ayakurayuki.psi.Types.GEO_DEFAULT_STMT;
import static cc.ayakurayuki.psi.Types.GEO_DELETE;
import static cc.ayakurayuki.psi.Types.GEO_DELETE_STMT;
import static cc.ayakurayuki.psi.Types.GEO_DIRECTIVE_STMT;
import static cc.ayakurayuki.psi.Types.GEO_INCLUDE;
import static cc.ayakurayuki.psi.Types.GEO_INCLUDE_STMT;
import static cc.ayakurayuki.psi.Types.GEO_PROXY;
import static cc.ayakurayuki.psi.Types.GEO_PROXY_STMT;
import static cc.ayakurayuki.psi.Types.GEO_RANGES;
import static cc.ayakurayuki.psi.Types.GEO_RANGES_STMT;
import static cc.ayakurayuki.psi.Types.GEO_STMT;
import static cc.ayakurayuki.psi.Types.GEO_VALUE_STMT;
import static cc.ayakurayuki.psi.Types.IDENTIFIER;
import static cc.ayakurayuki.psi.Types.IF;
import static cc.ayakurayuki.psi.Types.IF_DIRECTIVE_STMT;
import static cc.ayakurayuki.psi.Types.IF_PAREN_STMT;
import static cc.ayakurayuki.psi.Types.IF_STMT;
import static cc.ayakurayuki.psi.Types.LBRACE;
import static cc.ayakurayuki.psi.Types.LOCATION;
import static cc.ayakurayuki.psi.Types.LOCATION_DIRECTIVE_STMT;
import static cc.ayakurayuki.psi.Types.LOCATION_MODIFIER_STMT;
import static cc.ayakurayuki.psi.Types.LOCATION_PATH_STMT;
import static cc.ayakurayuki.psi.Types.LOCATION_STMT;
import static cc.ayakurayuki.psi.Types.LPAREN;
import static cc.ayakurayuki.psi.Types.LUA;
import static cc.ayakurayuki.psi.Types.LUA_BLOCK_DIRECTIVE;
import static cc.ayakurayuki.psi.Types.LUA_BLOCK_STMT;
import static cc.ayakurayuki.psi.Types.LUA_CODE_STMT;
import static cc.ayakurayuki.psi.Types.LUA_DIRECTIVE_STMT;
import static cc.ayakurayuki.psi.Types.LUA_STMT;
import static cc.ayakurayuki.psi.Types.MAP;
import static cc.ayakurayuki.psi.Types.MAP_BLOCK_CONTENT;
import static cc.ayakurayuki.psi.Types.MAP_BLOCK_STMT;
import static cc.ayakurayuki.psi.Types.MAP_DEFAULT;
import static cc.ayakurayuki.psi.Types.MAP_DEFAULT_STMT;
import static cc.ayakurayuki.psi.Types.MAP_DIRECTIVE_STMT;
import static cc.ayakurayuki.psi.Types.MAP_HOSTNAMES;
import static cc.ayakurayuki.psi.Types.MAP_HOSTNAMES_STMT;
import static cc.ayakurayuki.psi.Types.MAP_INCLUDE;
import static cc.ayakurayuki.psi.Types.MAP_INCLUDE_STMT;
import static cc.ayakurayuki.psi.Types.MAP_STMT;
import static cc.ayakurayuki.psi.Types.MAP_VALUE_STMT;
import static cc.ayakurayuki.psi.Types.MAP_VOLATILE;
import static cc.ayakurayuki.psi.Types.MAP_VOLATILE_STMT;
import static cc.ayakurayuki.psi.Types.NAME_STMT;
import static cc.ayakurayuki.psi.Types.QUOTE;
import static cc.ayakurayuki.psi.Types.RBRACE;
import static cc.ayakurayuki.psi.Types.REGULAR_DIRECTIVE_STMT;
import static cc.ayakurayuki.psi.Types.RPAREN;
import static cc.ayakurayuki.psi.Types.SEMICOLON;
import static cc.ayakurayuki.psi.Types.STRING;
import static cc.ayakurayuki.psi.Types.STRING_STMT;
import static cc.ayakurayuki.psi.Types.UNARY_OPERATOR;
import static cc.ayakurayuki.psi.Types.VALUE;
import static cc.ayakurayuki.psi.Types.VALUE_STMT;
import static cc.ayakurayuki.psi.Types.VARIABLE;
import static cc.ayakurayuki.psi.Types.VARIABLE_STMT;
...
public class NginxParser implements PsiParser, LightPsiParser {
    ...
    public static boolean block_stmt(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "block_stmt")) {
            return false;
        }
        if (!nextTokenIs(b, LBRACE)) {
            return false;
        }
        boolean r, p;
    ...
    private static boolean block_stmt_1(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "block_stmt_1")) {
            return false;
        }
        while (true) {
            ...
            if (!empty_element_parsed_guard_(b, "block_stmt_1", c)) {
                break;
            }
        }
        return true;
    ...
    public static boolean concatenated_expr(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "concatenated_expr")) {
            return false;
        }
        boolean r;
        ...
        while (r) {
            int c = current_position_(b);
            if (!concatenated_expr_0(b, l + 1)) {
                break;
            }
            if (!empty_element_parsed_guard_(b, "concatenated_expr", c)) {
                break;
            }
        }
    ...
    private static boolean concatenated_expr_0(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "concatenated_expr_0")) {
            return false;
        }
        boolean r;
    ...
    public static boolean condition_expr(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "condition_expr")) {
            return false;
        }
        boolean r;
    ...
    public static boolean condition_stmt(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "condition_stmt")) {
            return false;
        }
        boolean r;
    ...
    private static boolean condition_stmt_0(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "condition_stmt_0")) {
            return false;
        }
        boolean r;
    ...
    private static boolean condition_stmt_1(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "condition_stmt_1")) {
            return false;
        }
        boolean r;
        Marker m = enter_section_(b);
    ...
    private static boolean condition_stmt_1_1(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "condition_stmt_1_1")) {
            return false;
        }
    ...
    private static boolean condition_stmt_1_1_0(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "condition_stmt_1_1_0")) {
            return false;
        }
        boolean r;
        Marker m = enter_section_(b);
    ...
    public static boolean directive_stmt(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "directive_stmt")) {
            return false;
        }
        boolean r;
        ...
        if (!r) {
            r = map_directive_stmt(b, l + 1);
        }
        if (!r) {
            r = geo_directive_stmt(b, l + 1);
        }
        if (!r) {
            r = lua_directive_stmt(b, l + 1);
        }
        if (!r) {
            r = if_directive_stmt(b, l + 1);
        }
        if (!r) {
            r = location_directive_stmt(b, l + 1);
        }
        exit_section_(b, l, m, r, false, null);
        return r;
    }
    ...
    public static boolean geo_block_content(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "geo_block_content")) {
            return false;
        }
        boolean r;
        ...
        if (!r) {
            r = geo_default_stmt(b, l + 1);
        }
        if (!r) {
            r = geo_proxy_stmt(b, l + 1);
        }
        if (!r) {
            r = geo_ranges_stmt(b, l + 1);
        }
        if (!r) {
            r = geo_include_stmt(b, l + 1);
        }
        if (!r) {
            r = geo_value_stmt(b, l + 1);
        }
        exit_section_(b, l, m, r, false, null);
        return r;
    }
    ...
    public static boolean geo_block_stmt(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "geo_block_stmt")) {
            return false;
        }
        if (!nextTokenIs(b, LBRACE)) {
            return false;
    ...
    private static boolean geo_block_stmt_1(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "geo_block_stmt_1")) {
            return false;
        }
        while (true) {
            int c = current_position_(b);
            if (!geo_block_content(b, l + 1)) {
                break;
            }
            if (!empty_element_parsed_guard_(b, "geo_block_stmt_1", c)) {
                break;
            }
        }
        return true;
    ...
    public static boolean geo_default_stmt(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "geo_default_stmt")) {
            return false;
        }
        if (!nextTokenIs(b, GEO_DEFAULT)) {
            return false;
        }
        boolean r, p;
    ...
    public static boolean geo_delete_stmt(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "geo_delete_stmt")) {
            return false;
        }
        if (!nextTokenIs(b, GEO_DELETE)) {
            return false;
        }
        boolean r, p;
    ...
    public static boolean geo_directive_stmt(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "geo_directive_stmt")) {
            return false;
        }
        if (!nextTokenIs(b, GEO)) {
            return false;
        }
        boolean r, p;
    ...
    private static boolean geo_directive_stmt_2(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "geo_directive_stmt_2")) {
            return false;
        }
        variable_stmt(b, l + 1);
        return true;
    ...
    public static boolean geo_include_stmt(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "geo_include_stmt")) {
            return false;
        }
        if (!nextTokenIs(b, GEO_INCLUDE)) {
            return false;
        }
        boolean r, p;
    ...
    public static boolean geo_proxy_stmt(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "geo_proxy_stmt")) {
            return false;
        }
        if (!nextTokenIs(b, GEO_PROXY)) {
            return false;
        }
        boolean r, p;
    ...
    public static boolean geo_ranges_stmt(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "geo_ranges_stmt")) {
            return false;
        }
        if (!nextTokenIs(b, GEO_RANGES)) {
            return false;
        }
        boolean r, p;
    ...
    public static boolean geo_stmt(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "geo_stmt")) {
            return false;
        }
        if (!nextTokenIs(b, GEO)) {
            return false;
    ...
    public static boolean geo_value_stmt(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "geo_value_stmt")) {
            return false;
        }
        boolean r, p;
    ...
    public static boolean if_directive_stmt(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "if_directive_stmt")) {
            return false;
        }
        if (!nextTokenIs(b, IF)) {
            return false;
    ...
    public static boolean if_paren_stmt(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "if_paren_stmt")) {
            return false;
        }
        if (!nextTokenIs(b, LPAREN)) {
            return false;
        }
        boolean r, p;
    ...
    public static boolean if_stmt(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "if_stmt")) {
            return false;
        }
        if (!nextTokenIs(b, IF)) {
            return false;
    ...
    public static boolean location_directive_stmt(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "location_directive_stmt")) {
            return false;
        }
        if (!nextTokenIs(b, LOCATION)) {
            return false;
        }
        boolean r, p;
    ...
    private static boolean location_directive_stmt_1(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "location_directive_stmt_1")) {
            return false;
        }
    ...
    public static boolean location_modifier_stmt(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "location_modifier_stmt")) {
            return false;
        }
    ...
    private static boolean location_modifier_stmt_0(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "location_modifier_stmt_0")) {
            return false;
        }
        boolean r;
        r = consumeToken(b, BINARY_OPERATOR);
        if (!r) {
            r = consumeToken(b, CARET_TILDE);
        }
        return r;
    }
    ...
    public static boolean location_path_stmt(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "location_path_stmt")) {
            return false;
        }
        boolean r;
    ...
    public static boolean location_stmt(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "location_stmt")) {
            return false;
        }
        if (!nextTokenIs(b, LOCATION)) {
            return false;
    ...
    public static boolean lua_block_stmt(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "lua_block_stmt")) {
            return false;
        }
        if (!nextTokenIs(b, LBRACE)) {
            return false;
    ...
    public static boolean lua_code_stmt(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "lua_code_stmt")) {
            return false;
        }
        if (!nextTokenIs(b, LUA)) {
            return false;
        }
        boolean r;
        Marker m = enter_section_(b);
        ...
        while (r) {
            int c = current_position_(b);
            if (!consumeToken(b, LUA)) {
                break;
            }
            if (!empty_element_parsed_guard_(b, "lua_code_stmt", c)) {
                break;
            }
        }
    ...
    public static boolean lua_directive_stmt(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "lua_directive_stmt")) {
            return false;
        }
        if (!nextTokenIs(b, LUA_BLOCK_DIRECTIVE)) {
            return false;
        }
        boolean r, p;
    ...
    private static boolean lua_directive_stmt_1(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "lua_directive_stmt_1")) {
            return false;
        }
        while (true) {
            int c = current_position_(b);
            ...
            if (!empty_element_parsed_guard_(b, "lua_directive_stmt_1", c)) {
                break;
            }
        }
        return true;
    ...
    public static boolean lua_stmt(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "lua_stmt")) {
            return false;
        }
        if (!nextTokenIs(b, LUA_BLOCK_DIRECTIVE)) {
            return false;
    ...
    public static boolean map_block_content(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "map_block_content")) {
            return false;
        }
        boolean r;
        ...
        if (!r) {
            r = map_default_stmt(b, l + 1);
        }
        if (!r) {
            r = map_hostnames_stmt(b, l + 1);
        }
        if (!r) {
            r = map_include_stmt(b, l + 1);
        }
        if (!r) {
            r = map_value_stmt(b, l + 1);
        }
        exit_section_(b, l, m, r, false, null);
        return r;
    }
    ...
    public static boolean map_block_stmt(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "map_block_stmt")) {
            return false;
        }
        if (!nextTokenIs(b, LBRACE)) {
            return false;
    ...
    private static boolean map_block_stmt_1(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "map_block_stmt_1")) {
            return false;
        }
        while (true) {
            int c = current_position_(b);
            if (!map_block_content(b, l + 1)) {
                break;
            }
            if (!empty_element_parsed_guard_(b, "map_block_stmt_1", c)) {
                break;
            }
        }
        return true;
    ...
    public static boolean map_default_stmt(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "map_default_stmt")) {
            return false;
        }
        if (!nextTokenIs(b, MAP_DEFAULT)) {
            return false;
        }
        boolean r, p;
    ...
    public static boolean map_directive_stmt(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "map_directive_stmt")) {
            return false;
        }
        if (!nextTokenIs(b, MAP)) {
            return false;
        }
        boolean r, p;
    ...
    public static boolean map_hostnames_stmt(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "map_hostnames_stmt")) {
            return false;
        }
        if (!nextTokenIs(b, MAP_HOSTNAMES)) {
            return false;
        }
        boolean r, p;
    ...
    public static boolean map_include_stmt(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "map_include_stmt")) {
            return false;
        }
        if (!nextTokenIs(b, MAP_INCLUDE)) {
            return false;
        }
        boolean r, p;
    ...
    public static boolean map_stmt(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "map_stmt")) {
            return false;
        }
        if (!nextTokenIs(b, MAP)) {
            return false;
    ...
    public static boolean map_value_stmt(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "map_value_stmt")) {
            return false;
        }
        boolean r, p;
    ...
    public static boolean map_volatile_stmt(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "map_volatile_stmt")) {
            return false;
        }
        if (!nextTokenIs(b, MAP_VOLATILE)) {
            return false;
        }
        boolean r, p;
    ...
    public static boolean name_stmt(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "name_stmt")) {
            return false;
        }
    ...
    static boolean nginxFile(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "nginxFile")) {
            return false;
        }
        while (true) {
            int c = current_position_(b);
            ...
            if (!empty_element_parsed_guard_(b, "nginxFile", c)) {
                break;
            }
        }
        return true;
    ...
    public static boolean regular_directive_stmt(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "regular_directive_stmt")) {
            return false;
        }
        if (!nextTokenIs(b, IDENTIFIER)) {
            return false;
    ...
    private static boolean regular_directive_stmt_1(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "regular_directive_stmt_1")) {
            return false;
        }
    ...
    private static boolean regular_directive_stmt_2(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "regular_directive_stmt_2")) {
            return false;
        }
        while (true) {
            int c = current_position_(b);
            ...
            if (!empty_element_parsed_guard_(b, "regular_directive_stmt_2", c)) {
                break;
            }
        }
        return true;
    ...
    private static boolean regular_directive_stmt_3(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "regular_directive_stmt_3")) {
            return false;
        }
        boolean r;
    ...
    public static boolean string_stmt(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "string_stmt")) {
            return false;
        }
        if (!nextTokenIs(b, "<string stmt>", DQUOTE, QUOTE)) {
            return false;
        }
        boolean r;
    ...
    private static boolean string_stmt_0(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "string_stmt_0")) {
            return false;
        }
        boolean r;
        Marker m = enter_section_(b);
    ...
    private static boolean string_stmt_0_1(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "string_stmt_0_1")) {
            return false;
        }
    ...
    private static boolean string_stmt_1(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "string_stmt_1")) {
            return false;
        }
        boolean r;
        Marker m = enter_section_(b);
    ...
    private static boolean string_stmt_1_1(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "string_stmt_1_1")) {
            return false;
        }
    ...
    public static boolean value_stmt(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "value_stmt")) {
            return false;
        }
        boolean r;
    ...
    public static boolean variable_stmt(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "variable_stmt")) {
            return false;
        }
        if (!nextTokenIs(b, VARIABLE)) {
            return false;
        }
        boolean r;
        Marker m = enter_section_(b);

...
class NginxSyntaxHighlighter : SyntaxHighlighterBase() {
    ...
    companion object {
        ...
        private val VARIABLE = createTextAttributesKey("NGINX_VARIABLE", DefaultLanguageHighlighterColors.LOCAL_VARIABLE)
        ...
        private val LUA_BLOCK_DIRECTIVE = createTextAttributesKey("NGINX_LUA_BLOCK_DIRECTIVE", DefaultLanguageHighlighterColors.KEYWORD)
        ...
        private val MAP_VOLATILE = createTextAttributesKey("NGINX_MAP_VOLATILE", DefaultLanguageHighlighterColors.KEYWORD)
        private val MAP_HOSTNAMES = createTextAttributesKey("NGINX_MAP_HOSTNAMES", DefaultLanguageHighlighterColors.KEYWORD)
        private val OPERATOR = createTextAttributesKey("NGINX_OPERATOR", DefaultLanguageHighlighterColors.OPERATION_SIGN)
